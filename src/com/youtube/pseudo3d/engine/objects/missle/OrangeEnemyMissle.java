...
public class OrangeEnemyMissle extends ConstantlyMovingObject implements EnemyMissle{

	public static int DAMAGE = 2;
	
	private double mx, my;
	
	public OrangeEnemyMissle(GameLogic raycaster, Vector2d position) {
		...
		texture = TextureHolder.get(ID.ENEMY_ORANGE_MISSLE);
